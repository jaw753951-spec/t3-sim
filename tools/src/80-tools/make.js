...
function buildCustom(){
  const mk = o => {
    const n = {sym:o.sym, init:+o.init, val:+o.init, shielded:!!o.shielded,
      ...
      evolved:false, dead:false, dormT:0, rig:0, rigPart:0, rigPartMax:0, rigCap:0, rigLent:0, delayed:0, weak:0, diagRound:0, diagAcc:0,
  ...
  if(CUSTOM.dis){
    ...
    const dis={sym:'병', role:'disease', init:v0, val:v0, shielded:false, shReduc:0,
      stabAcc:0, grow:0, evo:99, evoLeft:99, evolved:false, dead:false, dormT:0, rig:0, rigPart:0, rigPartMax:0,
